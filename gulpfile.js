...
// Define file sources.
var sassFrontendSource        = [ 'dev/scss/wpbooklist-comments-main-frontend.scss' ];
var sassFrontendSourcePartial = [ 'dev/scss/_wpbooklist-comments-frontend-ui.scss' ];
var sassBackendSource         = [ 'dev/scss/wpbooklist-comments-main-admin.scss' ];
var sassBackendSourcePartial  = [ 'dev/scss/_wpbooklist-comments-backend-ui.scss' ];
...
gulp.task( 'concatAdminJs', function() {
	gulp.src(jsBackendSource ) // use jsSources
		.pipe(concat( 'wpbooklist_comments_admin.min.js' ) ) // Concat to a file named 'script.js'
...
gulp.task( 'concatFrontendJs', function() {
	gulp.src(jsFrontendSource ) // use jsSources
		.pipe(concat( 'wpbooklist_comments_frontend.min.js' ) ) // Concat to a file named 'script.js'
		.pipe(uglify() ) // Uglify concatenated file
		.pipe(gulp.dest( 'assets/js' ) ); // The destination for the concatenated and uglified file
});
