...
jQuery( document ).ready( function( $ ) {
	...
	function wpbooklistCommentsSubmitSettingsButton(){
		...
		$( document ).on( 'click', '#wpbooklist-comments-save-settings', function( event ) {
			...
			var allowregistration = $( '#wpbooklist-comments-allow-registration' ).val();

			var usermessage = $( '#wpbooklist-comments-user-messager' ).val();
			var registrationurl = $( '#wpbooklist-comments-registration-url' ).val();
			var registrationurltext = $( '#wpbooklist-comments-registration-url-text' ).val();
			...
			var data = {
				...
				'registrationurltext': registrationurltext
			};
